...
if __name__ == "__main__":
    ...
    # ups_check.ha_connection.run_cmd("pwd", quiet_mode=False)
    # ups_check.nas_connection.run_cmd("ls", quiet_mode=False)
    # ups_check.local_connection.run_cmd("dir", quiet_mode=False)  # win
    # # ups_check.local_connection.run_cmd("ls", quiet_mode=False)  # linux
    # response = ups_check.homeassistant_api.get("switch.e1_zoom_ftp_upload")
    # print(response)

    # for entity in ["schedule.backup_schedule", "input_boolean.nas_on"]:  # entity with a backup schedule
    #     api_response = ups_check.homeassistant_api.get(entity=entity)
    #     print(api_response)

    # api_response = ups_check.homeassistant_api("get", "switch.e1_zoom_ftp_upload")
    # print(api_response)
    #
    # out = ups_check.homeassistant_api.post(
    #     entity="switch.e1_zoom_ftp_upload",
    #     data={"state": "on"},
    # )
    # print(out)
    ...
    # ms_teams_status_entity = "input_select.intel_ms_teams_status"
    # ups_check.homeassistant_api(
    #     action="post",
    #     entity=ms_teams_status_entity,
    #     data={"option": "away"},
    #     # entity_type="input_select",
    # )
    # # data: {'option': 'away', 'entity_id': 'input_select.intel_ms_teams_status'}
    #
    # api_response = ups_check.homeassistant_api(action="get", entity=ms_teams_status_entity)
    # ms_teams_status = api_response.get("state", "offline")  # busy or offline ?
    # print(ms_teams_status)

    # x = api_response.get("state", "off")
    # print(x)

    # ups_check.omv_shutdown()
    # ups_check.omv_sleep()
    # ups_check.omv_wake_up()

    # print(ups_check.is_electricity())
